...
class GRUDisentangledAttention(nn.Module):
    ...
    def __init__(self, hidden_size = 1024, num_hidden_layers = 1, num_attention_heads = 8):
        ...
        self.model = DebertaModel(config)
        self.gru = GRUModel(input_dim = self.hidden_size, hidden_dim = self.hidden_size//2, num_layers = 1)
...
class LSTMDisentangledAttention(nn.Module):
    ...
    def __init__(self, hidden_size = 1024, num_hidden_layers = 1, num_attention_heads = 8):
        ...
        self.model = DebertaModel(config)
        self.lstm = LSTMModel(input_dim = self.hidden_size, hidden_dim = self.hidden_size//2, num_layers = 1)
...
class RNNDisentangledAttention(nn.Module):
    ...
    def __init__(self, hidden_size = 1024, num_hidden_layers = 1, num_attention_heads = 8):
        ...
        self.model = DebertaModel(config)
        self.rnn = RNNModel(input_dim = self.hidden_size, hidden_dim = self.hidden_size//2, num_layers = 1)
